...
// THIS FILE HAS BEEN SLIGHTLY MODIFIED by Frank Collebrusco

//#include <stdio.h>
#include <stdint.h>
#include "ST7735.h"
#include "../inc/tm4c123gh6pm.h"
extern "C" void Fix2String(uint32_t n, char*);
extern "C" void Dec2String(uint32_t n, char*);
extern "C" void sDec2String(uint32_t n, char*);
...
void ST7735_OutChar(char ch){
  if((ch == 10) || (ch == 13) || (ch == 27)){
	...
	//this line used to out char in default yellow only, changed to user choice -frank
