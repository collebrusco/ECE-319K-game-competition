...
//-----------------------sDec2String-----------------------
// Convert a 32-bit number in signed decimal format
...
extern "C" void sDec2String(int32_t n, char* m);
...
extern "C" void Dec2String(uint32_t n, char* m);
...
// n>9999, then create "*.***"
//void Fix2String(uint32_t n, char *string);
extern "C" void Fix2String(uint32_t n, char* m);
